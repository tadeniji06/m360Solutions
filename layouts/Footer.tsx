          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-sm leading-relaxed text-gray-300">
              ...
              <p>
                ...
                processes whilst ensuring customers' satisfaction.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-2">
                <Icon icon="mdi:phone" className="text-orange-500 text-lg" />
                <a
              ...
              <div className="flex items-center gap-3 mb-4">
                <Icon icon="mdi:email" className="text-orange-500 text-lg" />
                <a
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <Icon icon="mdi:whatsapp" className="text-orange-500 text-lg" />
                <a
