          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-gray-700 text-lg leading-relaxed">
                ...
                technological solutions designed to streamline operations,
                enhance productivity, and foster growth. Our expertise lies in
                transforming complex business challenges into seamless,
                efficient workflows using innovative tools and technologies.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Streamline operations to maximize efficiency and reduce
                      operational costs.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Scalable technology solutions that grow with your business
                      needs.
                    </p>
                  </div>
                </div>
