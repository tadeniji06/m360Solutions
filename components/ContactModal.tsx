            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-[20px] p-8 md:p-10 w-full max-w-lg relative shadow-2xl text-[#0b132a]">
                ...
                {isSuccess ? (
                    ...
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <input type="email" name="email" placeholder="Email Address" required className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:border-orange-500 transition-colors text-gray-900" />
